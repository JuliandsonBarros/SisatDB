...
ALTER TABLE [dbo].[Mensagens] WITH CHECK ADD CONSTRAINT [FK_Mensagens_Remetente] FOREIGN KEY(Id_Remetente)
REFERENCES [dbo].[Usuario] ([ID])
ALTER TABLE [dbo].[Mensagens] WITH CHECK ADD CONSTRAINT [FK_Mensagens_Destinatario] FOREIGN KEY([Id_Destinatario])
REFERENCES [dbo].[Usuario] ([ID])
